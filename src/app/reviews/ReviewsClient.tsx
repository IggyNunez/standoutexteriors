...
function StickyCTA() {
  return (
    ...
    >
      <Link href="/contact" style={{ flex: 1, background: "#C2410C", color: "white", fontWeight: 800, fontSize: "0.72rem", letterSpacing: "0.07em", textTransform: "uppercase", borderRadius: 9999, padding: "12px 0", textAlign: "center", textDecoration: "none", display: "block" }}>
        Free Estimate
      </Link>
...
export default function ReviewsClient() {
  ...
  const filteredReviews = filter === "photos" ? SORTED_REVIEWS.filter(r => r.photos.length > 0) : SORTED_REVIEWS;

  // Cap initial DOM. Show 24, expand by 24 per click. Reset count when filter changes.
  const PAGE_SIZE = 24;
      ...
      <main style={{ background: "linear-gradient(175deg,#061e38 0%,#0A2E5C 40%,#0d3870 100%)", minHeight: "100vh" }}>
        ...
        >
          ...
          <div className="max-w-[1920px] mx-auto text-center relative z-[1]">
            ...
            >
              <Link href="/contact"
                style={{ background: "#C2410C", color: "white", fontWeight: 800, fontSize: "0.72rem", letterSpacing: "0.08em", textTransform: "uppercase", borderRadius: 9999, padding: "14px 34px", textDecoration: "none", border: "2px solid rgba(255,255,255,0.15)", transition: "all 0.25s" }}
            ...
            {hasMore && (
              <div style={{ display: "flex", justifyContent: "center", marginTop: 40 }}>
                <button
                  ...
                  style={{ background: "rgba(255,255,255,0.06)", border: "1px solid rgba(255,255,255,0.18)", color: "white", fontWeight: 700, fontSize: "0.7rem", letterSpacing: "0.12em", textTransform: "uppercase", borderRadius: 9999, padding: "12px 28px", cursor: "pointer", transition: "all 0.22s" }}
                  className="hover:bg-white/10"
                >
                  Show {Math.min(PAGE_SIZE, filteredReviews.length - visibleCount)} More Reviews
                </button>
              </div>
            )}
          </div>
    ...
    <div ref={ref} className="max-w-[1920px] mx-auto relative z-[1]">
      <div className="text-center mb-12">
        ...
        >
          ...
          <span style={{ color: "#C2410C" }}>on Your Street?</span>
        </motion.h2>
        <motion.p
      ...
      >
        <div style={{ display: "flex", flexWrap: "wrap", justifyContent: "center", gap: 14, marginBottom: 20 }}>
          <Link href="/contact"
            style={{ background: "#C2410C", color: "white", fontWeight: 800, fontSize: "0.8rem", letterSpacing: "0.08em", textTransform: "uppercase", borderRadius: 9999, padding: "16px 44px", textDecoration: "none", boxShadow: "0 8px 32px rgba(249,115,22,0.4)", border: "2px solid rgba(255,255,255,0.15)", display: "inline-block", transition: "all 0.25s" }}
